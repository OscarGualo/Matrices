...
public class CalculadorEigen {
    ...
    /**
     * Este metodo sera privado ya que solo va a trabajar en la clase, el cual
     * va a calcular el valor propio de la matriz dada por el ususario
     *
     * @return returna un numero entero que es el valor propio asociado a la
     * matriz y al vector propio del usuario
     */
    ...
    public void mostrarVectorPropio() {
        ...
        System.out.println(" El vector propio es : " + Arrays.toString(vectorPropio));
    }
}
